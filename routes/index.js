...
router.get('/metabasecronroi', function(req, res, next) {
...
router.get('/metabaseeg', function(req, res, next) {
...
router.get('/metabaseae', function(req, res, next) {
...
router.get('/metabasebh', function(req, res, next) {
...
router.get('/metabaseiq', function(req, res, next) {
...
router.get('/metabasejo', function(req, res, next) {
...
router.get('/metabasekw', function(req, res, next) {
...
router.get('/metabaseps', function(req, res, next) {
...
router.get('/metabasesa', function(req, res, next) {
...
router.get('/metabasetn', function(req, res, next) {
